...
import { User, Calendar, CreditCard, Clock, CheckCircle, Building, Mail, Phone } from 'lucide-react';
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-slate-700">
                    {user?.created_at && format(new Date(user.created_at), 'dd MMMM yyyy', { locale: id })}
                  </p>
                </div>
              </div>
